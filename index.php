...
<section class="page-title o-hidden text-center grey-bg bg-contain animatedBackground" data-bg-img="images/pattern/05.png">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-12">
        <h1 class="title">OnlineArticle</h1>
    ...
    <div class="row">
        ...
        <div class="post">
          <div class="post-image">
            <img class="img-fluid h-100 w-100" src="./Admin/Articles/uploads/<?php echo $data['img']?>" alt="">
          </div>
          <div class="post-desc">
            ...
            <div class="post-title">
              <h5><a href="new.php?id=<?php echo $data['id']; ?>">T<?php echo $data['name'];?></a> || <?php echo $data['CatTitle'];?></h5>
            </div>
            <p><?php echo substr($data['description'],0,150);?></p>
            <div class="post-author">
              <div class="post-author-img">
                <img class="img-fluid" src="./Admin/users/uploads/<?php// echo $data['userImage']?>" alt="">
              </div> <span><?php echo "Publisher:" .$data['publisher'];?></span>
            </div>
          </div>
        </div>
      </div>
